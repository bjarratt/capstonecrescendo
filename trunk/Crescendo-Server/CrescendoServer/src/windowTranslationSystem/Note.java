package windowTranslationSystem;
...
//	private ArrayList<Beat> beats;
	...
	{
		this.pitch = pitch;
		this.jPitch = null/*MessageTranslationEngine.pitches.get(pitch)*/;
		this.length = length;
		this.jLength = /*MessageTranslationEngine.lengths.get(length)*/null;
		this.player = player;
//		beats = /*new ArrayList<Beat>()*/null;
		correct = true;
