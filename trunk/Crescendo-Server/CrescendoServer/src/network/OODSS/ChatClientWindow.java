 ...
 * @author bill
 */
public class ChatClientWindow extends JFrame implements ServerUpdateListener,
		ActionListener, WindowListener
{
	...
	public ChatClientWindow(NIOClient client, Scope scope)
	{
		 ...
		 */
		scope.put(ServerUpdateListener.SERVER_UPDATE_LISTENER, this);
	...
	@Override
	public void recievedUpdate(ServerUpdate response)
	{
		/*
	...
	public static void main(String[] args) throws IOException
	{
		 ...
		 */
		TranslationScope publicChatTranslations = ServerTranslations.get();
