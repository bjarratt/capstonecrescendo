...
public class Splash_Screen extends PApplet {
...
class Player
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "gameManagement.windowManagement.windows.Splash_Screen" });
  }
}
