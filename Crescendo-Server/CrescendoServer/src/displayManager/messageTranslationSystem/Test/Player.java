...
import displayManager.messageTranslationSystem.GameStateKeys;
...
public class Player implements Runnable
{
	...
	public void run()
	{
		try
		{
			...
			{
				Thread.sleep(1000);
				myCM.sendMessage(new String(player + "_" + GameStateKeys.SPLASH_SCREEN));
				Thread.sleep(1000);
				myCM.sendMessage(new String(player + "_" + GameStateKeys.GAME_TYPES));
				Thread.sleep(1000);
				myCM.sendMessage(new String(player + "_" + GameStateKeys.GAME_OPTIONS));
				Thread.sleep(1000);
				myCM.sendMessage(new String(player + "_" + GameStateKeys.START_GAME));
			}
		}
